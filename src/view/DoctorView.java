...
import data.datafarmacia;
import data.medicamento;
import data.sala;
import data.datasalas;
import javax.swing.*;
import java.awt.*;
import java.util.ArrayList;

public class DoctorView extends JFrame {
    private datapaciente db;
    ...
    public DoctorView(String nombreDoctor, String especialidad, databasepaciente pacienteDB) {
    ...
    private void mostrarPacientes(databasepaciente db) {
        ArrayList<datapaciente> listaPacientes = new ArrayList<>(db.getPaciente());
